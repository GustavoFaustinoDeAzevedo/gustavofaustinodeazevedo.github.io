...
const calculatorUX = (e, calculating, setCalculating, result, setResult) => {
...
export default handleClick = (e, calculating, setCalculating, result, setResult) => calculatorUX(e, calculating, setCalculating, result, setResult);
