import { ListFiles } from '@GustavOS/components';
...
import { StylesConfig } from '@GustavOS/components/NativeApplications/FilesExplorer/components/SystemFile/StyledFileWrapper/fileWrapperStyle';
