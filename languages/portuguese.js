      ...
      <section id="about" class="main-container">
        ...
        <div class="about-container">
          <div class="about-container-inside">
            <p>Sou recém-formado em Engenharia da Computação com paixão por criar interfaces amigáveis ao usuário, HTML,
              CSS, React e tema escuro. Equipado com habilidades em <strong>HTML, CSS, JavaScript e React.js,</strong>
              estou ansioso para <strong>empregar meu conhecimento em uma função de desenvolvedor front-end
                júnior.</strong> Acredito na <strong>aprendizagem contínua</strong> e estou entusiasmado com a
              <strong>perspectiva de contribuir para e aprender com uma equipe talentosa.</strong>
            </p>
          </div>
        </div>
      </section>
          ...
          <form id="contactForm" action="https://formspree.io/f/mnqelzyz" method="POST" target="placeholder">
            ...
            <div class="form-container">
              ...
              <div class="form-group">
                ...
                <textarea id="message" name="message" rows="5" placeholder="Sua mensagem aqui" required></textarea>
              </div>
            </div>
